    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantServices", x => new { x.AssistantId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_AssistantServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssistantServices_Users_AssistantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_Users_AssistantId",
                        column: x => x.AssistantId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantServices_ServiceId",
                table: "AssistantServices",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_AssistantId",
                table: "Sessions",
                column: "AssistantId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_ClientId_AssistantId_ServiceId",
                table: "Sessions",
                columns: new[] { "ClientId", "AssistantId", "ServiceId" },
                unique: true,
